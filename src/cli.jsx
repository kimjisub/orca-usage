...
화면 안에서:
  ...
  좌우 화살표로도 패널을 옮깁니다. 설정과 판정 화면에서는 좌우가 값을 옮기므로
  그때는 d 를 씁니다.
...
판정:
  ...
  가중치를 곱해 더한 값이라 늘 0 부터 100 입니다.
    ...
    당장    지금 붙어 다섯 시간에 쓸 양. 5h 창이 비어 있고 곧 리셋되면 큽니다
...
계정 표시:
  *         이름 앞의 별표는 Orca 가 지금 붙어 있는 계정입니다. provider 마다 따로입니다
  ...
  소진 권장  창이 흐른 것보다 뒤처져 있어 지금 태워야 합니다
  사용 자제  창이 흐른 것보다 앞서 써서 이대로면 리셋 전에 바닥이 납니다
`
